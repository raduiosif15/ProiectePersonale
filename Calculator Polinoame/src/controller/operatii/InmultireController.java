...
import view.operatii.InmultireFrame;

import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class InmultireController extends AbstractController {
    public InmultireController(InmultireFrame frame, boolean hasBackButton) {
